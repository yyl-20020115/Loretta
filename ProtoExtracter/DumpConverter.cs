...
namespace ProtoExtracter
{
    internal class LuaTreeDumperConverter : LuaSyntaxWalker
    {
        ...
        public object SpecializedCollections { get; private set; }
        ...
        public override void VisitTrivia(SyntaxTrivia trivia)
        {
            ...
            if (_includeDiagnostics)
            {
                ...
                children = diagnosticNode is null ? null : new TreeDumperNode[] { diagnosticNode };
            }
        ...
        private static IEnumerable<T>? Concat<T>(IEnumerable<T>? enumerable, T? value) =>
            value is null ? enumerable : (enumerable?.Concat(new T[] { value }) ?? new T[] { value });
